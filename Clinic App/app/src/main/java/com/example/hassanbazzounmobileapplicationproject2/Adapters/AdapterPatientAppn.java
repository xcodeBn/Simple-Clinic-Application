...
public class AdapterPatientAppn extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterPatientAppn(Context c, Activity Act) {
        itemList = new ArrayList<Appoinments>();
        this.c = c;
        this.activity = Act;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        try {
            ...
            if (viewType == VIEW_ITEM) {
                ...
                return new holder_text(LayoutInflater.from(parent.getContext()).inflate(R.layout.appoinments_items, parent, false));
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        try {
            if (holder instanceof holder_text) {
                ...
                ((holder_text) holder).symptDes.setText(itemList.get(position).getSymptomsDescription());
    ...
    public void addAll(ArrayList<Appoinments> itemList2) {
        itemList.clear();
    ...
    public class holder_text extends RecyclerView.ViewHolder {
        ...
        public holder_text(View itemView) {
            ...
            super(itemView);
            date = (TextView) itemView.findViewById(R.id.dateAppoinment);
            symptDes = (TextView) itemView.findViewById(R.id.symptsAppoinment);
